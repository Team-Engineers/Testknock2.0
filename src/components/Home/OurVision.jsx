            ...
            <div className='grid max-w-[1480px] pt-10 mx-auto mb-20  sm:grid-cols-2 gap-5 px-5'>
                <div className='text-white '>
                    <div className='relative '>
                        <img className='absolute z-[0] sm:w-[50vw] 2xl:h-[520px] max-sm:h-[300px] w-screen lg:h-[560px] xl:h-[520px]' src={background} alt="" />
                    </div>
                    <div className='relative p-6 max-sm:pb-2  flex flex-col justify-end 2xl:h-[520px] max-sm:h-[300px] lg:h-[560px] xl:h-[520px] z-[1]'>
                        <div className='sm:h-[60px] h-[40px] w-[40px] sm:w-[60px] font-bold sm:text-2xl m-1 flex justify-center items-center absolute bg-[#C77DEE] rounded-full right-0 top-0 '>
                            <h1 className=''><BsArrowUpRight /></h1>
                        </div>
                        <h1 className='text-[#BD5D90] font-bold mb-6'>
                            Our Story
                        </h1>
                        <h1 className='font-bold max-sm:text-[13px]' >
                            Bridging the Gap: Unleashing Innovation in Content & Tech
                        </h1>
                        <h1 className='mt-2 mb-6 max-sm:text-[12px]'>
                        ...
                        <button className='p-2 w-fit sm:px-12 px-5 rounded-3xl max-sm:text-[10px] bg-gradient-to-r from-[#B47BFC] via-[#F181C7] to-[#FFA38C]'>
                            Learn More
                        </button>
                    </div>
                </div>
                <div className='gap-5 flex flex-col justify-center'>
                    <div className='bg-[#B47BFC] rounded-2xl p-6 text-white relative'>
                        <div className='sm:h-[60px] h-[40px] w-[40px] sm:w-[60px] font-bold sm:text-2xl m-2 flex text-white justify-center items-center absolute bg-[#2B2338] rounded-full right-0 top-0 '>
                            <h1 className=''><BsArrowUpRight /></h1>
                        </div>
                        <h1 className='font-bold max-sm:text-[13px] mb-8'>
                            Our Vision
                        </h1>
                        <h1 className='font-bold max-sm:text-[13px] mb-5'>The Content & Tech Revolution: Empowering You <br /> Through Innovation</h1>
                    ...
                    <div className='bg-[#FF7FC2]  rounded-2xl p-6 text-white relative'>
                        ...
                        <h1 className='font-bold max-sm:text-[13px] mb-5'>Beyond Textbooks: Your Personalized Learning Journey <br /> Starts Here</h1>
                        <h1 className='max-sm:text-[12px]'>
