  ...
  return (
    <div className='md:min-h-[500px] max-sm:mt-5 pb-10 flex justify-center items-center relative overflow-hidden'>
      ...
      <div className='text-white text-center space-y-6 relative z-10'>
        ...
        <h1 className='max-sm:text-[14px]  max-sm:px-8'>Unleash your potential. Our expert solutions, top-tier IT services, and educational content creation empower you <br className='max-md:hidden' />
          to achieve game-changing results. Track progress and optimize every step with our proven strategies. Contact us today!</h1>
