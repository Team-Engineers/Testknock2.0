...
const VerticalTimeline = () => {
    ...
    return (
        <div className=" mx-auto max-w-[1480px] p-8 px-4">
            <div>
                <h1 className='text-white text-4xl font-bold  mb-20 text-center'>What are you getting from {WebsiteName}?</h1>
            </div>
            <div className="relative">
                <div className="absolute left-1/2 z-[0] transform -translate-x-1/2 w-[1.5px] h-full bg-gray-200"></div>
